...
class Signin extends React.Component {
 ...
 this.setState({signInPassword: event.target.value});
  ...
  onSubmitSignin = () => {
    ...
    fetch('http://peaceful-harbor-83036.herokuapp.com/signin',{
    ...
    .then(u => {
      console.log(u);
         if (u.id){
            this.props.loadUser(u);
            this.props.onRouteChange('home');
            }
          else
          {

            this.setState({errMsg : u})
          }
  ...
  <div className="measure">
    ...
    <div className="1h-copy mt3">
       <p className="f4 dark-red link dim black db">{this.state.errMsg}</p>
    </div>
  </div>
</main>
</article>
